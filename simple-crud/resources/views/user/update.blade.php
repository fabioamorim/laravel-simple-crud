            ...
            <article class="card-body"> 
                <form id="formulario"  method="POST" action="/user/update">
                    <div class="col-sm-12 form-group"> 
                        ...
                        <input name="cpf" class="form-control  input" type="text" data-mask="000.000.000-00" placeholder="Cpf" value="{{ $user->cpf }}"><br>
                        <input name="email" class="form-control  input" type="text" placeholder="E-mail" value="{{ $user->email }}"><br>
                        <input name="phone_number" class="form-control  input" type="text" data-mask="(00) 00000-0000"  placeholder="Phone Number" value="{{ $user->phone_number }}"><br>
